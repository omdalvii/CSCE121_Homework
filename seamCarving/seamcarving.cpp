...
int main() {
  ...
  // validate input
  if (targetHeight < 0 || targetHeight > static_cast<int>(height) || targetHeight > static_cast<int>(MAX_HEIGHT) ||
      targetWidth < 0 || targetWidth > static_cast<int>(width) || targetWidth > static_cast<int>(MAX_WIDTH))
  {
